...
public class SalesOrderQueryUtil {
	...
	public static final String getSalesOrderList = "select sales_order_no as countValue, customer_code as customer,terms_n_conditions as termCondition,currency as currency,to_char(exp_date_of_delivery,'YYYY-MM-DD') as deliveryDate,sales_order_no as countValue from sales_order_hdr";
