...
public class SalesOrderQueryUtil {
	...
	public static final String INSERT_SALES_ORDER_HDR= "INSERT into sales_order_hdr (customer_code,terms_n_conditions,currency,exp_date_of_delivery,created_by,created_dt,sales_order_no,sales_quote_no,modified_by) "
			+ " values(:customer,:termCondition,:currency,to_date(:deliveryDate,'YYYY-MM-DD'),'E0001',now(),:countValue,:salesQuoteNo,:modifiedBy) RETURNING sales_order_no as salesOrderNo";
	public static final String GETCOUNT = "select * From fn_generate_reference_no('sales_order_hdr', 'sales_order_no','S','4')";
	public static final String getSalesOrderList = "select customer_code as customer,terms_n_conditions as termCondition,currency as currency,to_char(exp_date_of_delivery,'YYYY-MM-DD') as deliveryDate,sales_order_no as countValue from sales_order_hdr";
