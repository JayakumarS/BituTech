...
public class BankPaymentQueryUtil {
	...
	public static final String SELECT__BANK_PAYMENT_DTL = "select voucher_no as voucherNo,currency as currency,sub_account_code as subAccountCode,short_detail as shortDetails,conversion_rate as amount,acct_head as accountName from cashbank_pay_dtl where voucher_no=? ";
