...
//PR HDR
	public static final String INSERT_PURCHASE_REQUISITION = "INSERT into purchase_requisition (requisition_number,company_code,request_type,requisition_date,source_location,destination_location,requested_by,pr_request_number,costcenter,created_by,created_date) "
			+ " values(:requisitionNo,:company,:requestType,to_date(:requestDate,'dd/mm/yyyy'),:sourceLocation,:destinationLocation,:requestedBy,:prReqNo,:costCenter,'E0001',now()) Returning purchase_requisition_id as requisitionId";
	public static final String getPurchaseRequestList = "select purchase_requisition_id as requisitionId,requisition_number as requisitionNo,company_code as company,request_type as requestType,to_char(requisition_date,'DD/MM/YY') as requestDate, source_location as sourceLocation,destination_location as destinationLocation,requested_by as requestedBy,pr_request_number as prReqNo,costcenter as costCenter from purchase_requisition  ";
//	public static final String getUomcategoryList = "select uomcategory_code as id,uomcategory_name as text from uom_category";
	public static final String SELECT_PURCHASE_REQUISITION = "select purchase_requisition_id as requisitionId,company_code as company, request_type as requestType,to_char(requisition_date,'DD/MM/YY') as  requestDate, source_location as sourceLocation,destination_location as destinationLocation,requested_by as requestedBy,pr_request_number as prReqNo,costcenter as costCenter from purchase_requisition where purchase_requisition_id=?";
	public static final String UPDATE_PURCHASE_REQUISITION = "update purchase_requisition set company_code=:company,request_type=:requestType,requisition_date= to_date(:requestDate,'YYYY-MM-DD'),source_location=:sourceLocation,requested_by=:requestedBy,destination_location=:destinationLocation,costcenter=:costCenter where purchase_requisition_id=:requisitionId ";
