...
//PR HDR
	...
	public static final String getPurchaseRequestList = "select remarks as jobTitle, purchase_requisition_id as requisitionId,requisition_number as requisitionNo,company_code as company,request_type as requestType,to_char(requisition_date,'DD/MM/YY') as requestDate,l1.location_name as sourceLocationName,l.location_name as destinationName ,requested_by as requestedBy,pr_request_number as prReqNo,costcenter as costCenter from purchase_requisition pr left join location l on l.location_id=pr.destination_location left join location l1 on l1.location_id= pr.source_location";
